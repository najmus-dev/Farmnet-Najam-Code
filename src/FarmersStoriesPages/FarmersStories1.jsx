...
import farmer1 from "../Assets/farmer1.mp4"
import clock from "../Assets/clock.png";

const FarmersStories1 = () => {
  ...
  return (
    ...
    <div className="font-Inter mb-20">
      ...
      <div className="relative  mb-6 ">
          ...
          <video
            ref={videoRef}
            className="md:w-[1440px] md:h-[778px] object-cover sm:w-[620px] sm:h-[320px]"
            controls={false} 
            muted
...
export default FarmersStories1;
