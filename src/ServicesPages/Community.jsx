  ...
  return (
    <>
      <div className="p-5 top-[180px] font-Inter text-base md:text-xl">
        ...
        <div className="mt-2">
          <p className="lg:text-[32px] leading-[150%] ">
            Farmers can join app-based communities, where they can share
            knowledge, resources,
            <br /> and best practices with peers, fostering collaboration and
            collective growth.
          </p>
        </div>
        <div className="mt-6">
          <p className="font-bold lg:text-[32px] leading-[150%]">
            How to get into a community
          </p>
      ...
      <div className="p-6 top-[105px] font-Inter text-base md:text-xl">
        ...
        <div className="mt-2">
          <p className="lg:text-[32px] leading-[150%]">
            Click on user goes to community , then to categories, views &
            selects desired contracts.
            <br /> Request to join community.
          </p>
        </div>
        ...
        <p className="mt-2 lg:text-[32px] leading-[150%]">Mobilise resources</p>
        <p className="mt-2 lg:text-[32px] leading-[150%]">
          Share Best practice
        </p>
        <p className="mt-2 lg:text-[32px] leading-[150%] ">
          Competitive procurement of Inputs{" "}
        </p>
        <p className="mt-2 lg:text-[32px] leading-[150%] border-[#979797] border-b-[2px]">
          Market Produce & Services
        </p>
      </div>
