  ...
  return (
    <>
      <div className="p-5 top-[180px] font-Inter text-base md:text-xl">
        ...
        <div className="mt-2">
          <p className="lg:text-[32px] leading-[150%] ">
            User goes to rewards. Checks the points that they have gained.
            Redeem points
          </p>
        </div>
        <div className="mt-6">
      ...
      <div className="p-6 top-[105px] font-Inter text-base md:text-xl">
        ...
        <p className="mt-2 lg:text-[32px] leading-[150%]">Gain Points</p>
        <p className="mt-2 lg:text-[32px] leading-[150%]">Redeem Points</p>
      </div>
