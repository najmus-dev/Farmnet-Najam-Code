  ...
  return (
    <>
      <div className="p-5 top-[180px] font-Inter text-base md:text-xl">
        ...
        <div className="mt-2">
          <p className="lg:text-[32px] leading-[150%] ">
            Farmers receive comprehensive catalogs showcasing the produce and
            services they <br />
            offer, which can also be used for marketing purposes
          </p>
        </div>
        <div className="mt-6">
          <p className="font-bold lg:text-[32px] leading-[150%]">
            How to get Catalogues
          </p>
      ...
      <div className="p-6 top-[105px] font-Inter text-base md:text-xl">
        ...
        <div className="mt-2">
          <p className="lg:text-[32px] leading-[150%]">
            User updates profile with produce or services they offer. The same
            produce on the Profile are updated on the catalogue.
          </p>
        </div>
      ...
      <div className="p-6 font-Inter text-base md:text-xl flexcflex-col md:flex-row justify-between items-center">
        <div>
