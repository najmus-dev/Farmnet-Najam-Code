  ...
  return (
    <>
      <div className="p-5 top-[180px] font-Inter text-base md:text-xl">
        ...
        <div className="mt-2">
          <p className="lg:text-[32px] leading-[150%] ">
            Click on user goes to contract , then to categories, views & selects
            desired contracts.
            <br /> Request to join contracts..
          </p>
        </div>
        <div className="mt-6">
          <p className="font-bold lg:text-[32px] leading-[150%]">
            How to get into a contract.
          </p>
      ...
      <div className="p-6 top-[105px] font-Inter text-base md:text-xl">
        ...
        <p className="mt-2 lg:text-[32px] leading-[150%]">
          {" "}
          Market Assurance for Farmer
        </p>
        <p className="mt-2 lg:text-[32px] leading-[150%]">
          Offtake partners secure raw material for production
        </p>
      </div>
