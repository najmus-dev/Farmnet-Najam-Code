      ...
      <div className="p-5 top-[180px] font-Inter text-base md:text-xl">
        ...
        <div className="mt-2">
          <p className="lg:text-[32px] leading-[150%] ">
            User updates profile with produce or services they offer. The
            produce are displayed on <br />
            the market
          </p>
        </div>
        <div className="mt-6">
          <p className="font-bold lg:text-[32px] leading-[150%]">
            How to Market produce and services
          </p>
      ...
      <div className="p-6 top-[105px] font-Inter text-base md:text-xl">
        ...
        <div className="mt-2">
          <p className="lg:text-[32px] leading-[150%]">
            ...
            screen to open profile
            <br /> updates and shares or advertises products.
          </p>
        </div>
