...
// import crop11 from "../Assets/crop11.png";
...
//           </p>
//         </div>
//         <div className="w-full   pt-10 h-auto md:h-[580px] space-x-4 bg-[#FBFEFD] rounded-r-md flex  items-center justify-center ">
//           {/* Card 1 */}
...
//               <button className="bg-[#155528] mt-36 text-white font-semibold text-[12px] md:text-[14px] rounded-tr-lg rounded-bl-lg w-full md:w-[151px] h-[34px] text-center">
//                 View More
//               </button>
//             </div>
//           </div>
...
//           {/* Card 2 */}
//           <div className="w-full md:w-[304px] h-auto">
//             <img
//               src={crop2}
//               alt="crop2"
//               className="w-full  md:w-[275px] h-[230px] object-cover rounded-md"
...
//         <img src={crop11} alt="crop11" className="w-full " />
