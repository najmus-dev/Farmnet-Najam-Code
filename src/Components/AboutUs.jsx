...
const AboutUs = () => {
  return (
    <div className=" mt-24 md:mt-32 px-6 md:px-8   mb-10 font-Inter">
      <h2 className="text-[#155528] mb-3 md:mb-4 font-bold text-2xl md:text-[40px] ">
        #FARMINGISCOOL
      </h2>
      <div className="flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2 ">
          ...
          <button className="bg-[#155528] mt-4 text-white text-[24px] font-semibold w-full  rounded-tr-2xl rounded-bl-2xl  px-6 h-[60px] md:h-[79px] hover:bg-green-700">
            Read More
          </button>
        </div>
        ...
        <div className="lg:w-1/2 mt-8 lg:mt-0 md:pl-14">
          <img
            ...
            className="rounded-sm w-[624px] md:h-[410px] lg:w-full"
          />
        </div>
      </div>
    </div>
