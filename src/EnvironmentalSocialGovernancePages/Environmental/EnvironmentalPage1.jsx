...
// import environmental1 from "../../Assets/environmental1.png";
// import { IoMdArrowDropdown } from "react-icons/io";

// const EnvironmentalPage1 = () => {
//   return (
...
//       <div className=" rounded-2xl mb-6 font-semibold">
//         {/* Country Filter section*/}
//         <div className="flex">
//           <h1 className="text-white bg-[#155528] p-4 w-2/3">Country</h1>
//           {/* Country Filter with Custom Dropdown Icon */}
//           <div className="relative w-1/2">
//             <select
//               id="country"
//               className="p-4 w-full focus:outline-none focus:ring-2 focus:ring-green-600 bg-[#5C9247] text-white appearance-none pr-10"
//             >
...
//         <div className="flex">
//           <h1 className="bg-[#83C543] p-4 w-2/3">Type of report</h1>

//           {/* Custom Dropdown with Icon */}
//           <div className="relative w-1/2">
//             <select
//               id="reportType"
//               className="p-4 w-full focus:outline-none focus:ring-2 focus:ring-green-600 bg-[#F3F368] text-black appearance-none pr-10"
//             >
...
// export default EnvironmentalPage1;

// import React from "react";
// import { HiSearch } from "react-icons/hi";
// import environmental11 from "../../Assets/environmental11.png";
// import { IoMdArrowDropdown } from "react-icons/io";
...
//         {/* Country Filter section*/}
//         <div className="flex">
//           <h1 className="text-white bg-[#155528] p-2 md:p-6 rounded-tl-lg font-bold md:text-[28px] md:w-[830px] md:h-[90px]">
//             Country
//           </h1>
//           {/* Country Filter with Custom Dropdown Icon */}
//           <div className="relative ">
//             <select
//               id="country"
//               className="w-full focus:outline-none p-2 md:p-6 rounded-tr-lg font-bold md:text-[28px] md:w-[590px] md:h-[90px] focus:ring-2 focus:ring-green-600 bg-[#5C9247] text-white appearance-none md:pr-10"
//             >
//               <option value="Angola">Angola</option>
//               <option value="Botswana">Botswana</option>
//               <option value="Cameroon">Cameroon</option>
...
//         {/* Type of Report Filter section*/}
//         <div className="flex">
//           <h1 className="bg-[#83C543] p-2 md:p-6 rounded-bl-lg font-bold md:text-[28px] md:w-[830px] md:h-[90px]">
//             Type of report
//           </h1>
...
//             <select
//               id="reportType"
//               className=" w-full p-2 md:p-6  font-bold md:text-[28px] md:w-[590px] md:h-[90px] rounded-br-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 bg-[#F3F368] text-black appearance-none md:pr-10"
//             >
...
//             <h1 className="italic text-[24px] ">Opening Date</h1>
//             <img src={calender} alt="calender" className="w-[25px] h-[26px]" />
//           </div>
//           <div className="flex space-x-4 items-center">
//             <h1 className="italic text-[24px]">Closing Date</h1>
//             <img src={calender} alt="calender" className="w-[25px] h-[26px]" />
//           </div>
//         </div>
//       </div>
...
//         <h1 className="font-bold text-2xl md:text-[40px]">CO2 Abating</h1>
...
//         </div>
//       </div>
//       <p className="md:text-[34px] leading-5 mt-10">
...
//         future generations.
//       </p>
//       <h1 className="font-bold md:text-[32px] mt-12 mb-4">
//         SUSTAINABILITY PRIORITIES{" "}
//       </h1>
//       {/* <h1 className="font-bold text-[24px] mb-8">
...
const EnvironmentalPage1 = () => {
  return (
    <div className="p-4 md:p-10 font-Inter overflow-x-hidden">
      ...
      <ReportsGraph />
      <h1 className="font-bold text-2xl md:text-[32px] mt-4 md:mt-8 mb-6">
        Forestation
      </h1>
      ...
      <ReportsGraph />
      <h1 className="font-bold text-2xl md:text-[32px] mt-4 md:mt-8 mb-4">
        Reforestation
      </h1>
      <p className="text-base md:text-[34px] leading-5 md:leading-10">
        In 2024, maize production in Namibia is projected to experience an
