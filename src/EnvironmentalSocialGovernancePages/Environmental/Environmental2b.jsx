...
import ENVIRONMENTAL2a from "../../Assets/ENVIRONMENTAL2a.png";
...
const Environmental2b = () => {
  const [selectedCountry, setSelectedCountry] = useState("Namibia");
  const [isOpen, setIsOpen] = useState(false);

  const countries = [
    { name: "Angola", icon: reportslocationicon },
    { name: "Botswana", icon: reportslocationicon },
    { name: "Cameroon", icon: reportslocationicon },
    { name: "DRC", icon: reportslocationicon },
    { name: "Cote d'Ivoire", icon: reportslocationicon },
    { name: "Eswatini", icon: reportslocationicon },
    { name: "Ethiopia", icon: reportslocationicon },
    { name: "Ghana", icon: reportslocationicon },
    { name: "Kenya", icon: reportslocationicon },
    { name: "Lesotho", icon: reportslocationicon },
    { name: "Malawi", icon: reportslocationicon },
    { name: "Mozambique", icon: reportslocationicon },
    { name: "Namibia", icon: reportslocationicon },
    { name: "Nigeria", icon: reportslocationicon },
    { name: "Rwanda", icon: reportslocationicon },
    { name: "Senegal", icon: reportslocationicon },
    { name: "Somalia", icon: reportslocationicon },
    { name: "South Africa", icon: reportslocationicon },
    { name: "South Sudan", icon: reportslocationicon },
    { name: "Tanzania", icon: reportslocationicon },
    { name: "Uganda", icon: reportslocationicon },
    { name: "Zambia", icon: reportslocationicon },
    { name: "Zimbabwe", icon: reportslocationicon },
  ];
      ...
      <div className=" mb-6 md:mb-12 font-semibold ">
        ...
        <div className="flex">
          ...
          <div className="relative w-1/2 md:w-[590px]">
            <div className="focus:outline-none p-2 md:p-6 rounded-tr-lg font-bold md:text-[28px] w-full md:w-[590px] md:h-[90px] focus:ring-2 focus:ring-green-600 bg-[#5C9247] text-white appearance-none">
              <div
                className="flex justify-between items-center"
                onClick={() => setIsOpen(!isOpen)}
              >
                <span className="font-bold md:text-[28px]">
                  {selectedCountry}
                </span>
              ...
              {isOpen && (
                <div
                  className="absolute z-10 w-full mt-2 text-black text-[16px] font-normal bg-[#EBEBEB]"
                  style={{ left: 0 }}
                >
                  {countries.map((country) => (
                    <div
                      key={country.name}
                      className="flex items-center p-2 cursor-pointer hover:bg-[#afafaf]"
...
export default Environmental2b;
