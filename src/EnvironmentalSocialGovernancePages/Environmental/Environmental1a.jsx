...
import ENVIRONMENTAL1aa from "../../Assets/ENVIRONMENTAL1aa.png";
import ENVIRONMENTAL1bb from "../../Assets/ENVIRONMENTAL1bb.png";
import ENVIRONMENTAL1cc from "../../Assets/ENVIRONMENTAL1cc.png";
import ENVIRONMENTAL1dd from "../../Assets/ENVIRONMENTAL1dd.png";

const Environmental1a = () => {
    ...
    <div className="p-4 md:p-8 font-Inter overflow-x-hidden">
      ...
      <div className="mb-6">
        <h1 className="text-[#155528] font-bold text-2xl md:text-[36px]">
          ENVIRONMENTAL SOCIAL & BOVERNANCE (ESG)
        </h1>
      </div>
      {/* Search and Filters */}
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-between mt-10 mb-10 md:space-x-20 space-y-4 md:space-y-0">
        ...
        <div className="flex flex-col md:flex-row items-center md:justify-between space-y-4 md:space-y-0 md:space-x-36 w-full md:w-auto">
          ...
          <div className="relative w-full md:w-auto">
            ...
            {isCropOpen && (
              <div className="absolute mt-2 bg-white shadow-md rounded-md w-full md:w-[200px] z-10">
          ...
          <div className="relative w-full md:w-auto">
            ...
            {isCrop2Open && (
              <div className="absolute mt-2 shadow-md rounded-md w-[239px] z-10 bg-[#155528]">
                <ul className="p-4 space-y-2 text-white">
                  {["Flowers", "Plants", "Herbs"].map((item) => (
                    <li
                      key={item}
                      className="hover:bg-[#1b6346] p-2 cursor-pointer"
                    >
                      {item}
                    </li>
                  ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 px-2 md:px-0">
        <img
          src={ENVIRONMENTAL1aa}
          alt="ENVIRONMENTAL1aa"
          className="w-full h-auto md:h-[397px] object-cover rounded-t-md cursor-pointer"
        />
        <img
          src={ENVIRONMENTAL1bb}
          alt="ENVIRONMENTAL1bb"
          className="w-full h-auto md:h-[397px] object-cover rounded-t-md cursor-pointer"
        />
        <img
          src={ENVIRONMENTAL1cc}
          alt="ENVIRONMENTAL1cc"
          className="w-full h-auto md:h-[397px] object-cover rounded-t-md cursor-pointer"
        />
        <img
          src={ENVIRONMENTAL1dd}
          alt="ENVIRONMENTAL1dd"
          className="w-full h-auto md:h-[397px] object-cover rounded-t-md cursor-pointer"
        />
      </div>
...
export default Environmental1a;
