  ...
  return (
    <div className="p-4 md:p-8 mt-4 font-Inter overflow-x-auto">
      ...
      <div className="mb-6 font-semibold">
        ...
        <div className="flex ">
          <h1 className="text-white bg-[#155528] p-2 md:p-6 rounded-tl-lg font-bold md:text-[32px] w-1/2 md:w-[830px] md:h-[90px]">
            Country
          </h1>
          ...
          <div className="relative w-1/2 md:w-[590px]">
            <div
              className="focus:outline-none p-2 md:p-6 font-bold md:text-[32px] w-full md:w-[590px] md:h-[90px] rounded-tr-lg focus:ring-2 focus:ring-green-600 bg-[#5C9247] text-white appearance-none flex items-center justify-between cursor-pointer"
        ...
        <div className="flex">
          <div className="relative w-1/2 md:w-[830px] md:h-[90px]">
            <select
              id="reportType"
              onChange={handleTypeChange}
              className="p-2 md:p-6 z-10 bg-[#83C543] rounded-bl-lg font-bold md:text-[32px] w-full md:w-[830px] md:h-[90px] text-black appearance-none md:pr-10"
            >
              <option
          ...
          <div className="relative w-1/2 md:w-[590px]">
            <div
              className="focus:outline-none p-2 md:p-6 font-bold md:text-[32px] w-full md:w-[590px] md:h-[90px] rounded-br-lg focus:ring-2 focus:ring-yellow-500 bg-[#F3F368] text-black appearance-none flex items-center justify-between cursor-pointer"
        ...
        <div className="space-y-4 mt-6 md:mt-10">
          <div className="flex md:flex-row flex-col md:justify-between md:items-center">
            ...
            {selectedType === "Crop" && (
              <div className="relative">
                <div
                  className="focus:outline-none uppercase  font-bold md:text-[32px] w-full  rounded-tr-lg focus:ring-2 focus:ring-green-600 bg-white text-[#155528] appearance-none flex items-center justify-between cursor-pointer md:mr-24"
            ...
            {selectedType === "Livestock" && (
              <div className="relative">
                <div
                  className="focus:outline-none uppercase  font-bold md:text-[32px] w-full  rounded-br-lg focus:ring-2 focus:ring-yellow-500 bg-white text-[#155528] appearance-none flex items-center justify-between cursor-pointer md:mr-24"
          ...
          <div className="flex md:flex-row flex-col md:justify-between md:items-center">
            {/* <div className="flex space-x-4 md:space-x-8">
              <h1 className="text-2xl md:text-[40px] font-bold">Production</h1>
              <h1 className="text-2xl md:text-[40px] font-semibold text-[#919291]">
                | Featured report
              </h1>
            </div> */}
      ...
      <div className="mt-16">
        <div className="flex items-center justify-between">
          <h3 className="text-black font-bold text-xl md:text-[34px]">
            Featured Report
          </h3>
          <img
            src={demoicon}
