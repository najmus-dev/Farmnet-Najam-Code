...
// import donation from "../../Assets/donation.png"; // Make sure this is the correct image path

// const SeedDonationPage = () => {
//   return (
//     <div className="flex items-center justify-center  bg-white">
//       <div className="w-[1360px] h-[991px] bg-[#FAFBFB] border border-[#919291]">
//         <div className="pt-6">
//           <h1 className="text-bold text-[32px] font-bold text-center mb-6">
//             Support -A-Community of farmers
//           </h1>
//           <img
//             src={donation} // Replace with your actual image path or variable
//             alt="Support A Community of Farmers"
//             className="w-[1360px] h-[686px] object-cover"
//           />
//         </div>
//       </div>
//     </div>
...
// export default SeedDonationPage;
...
//         Cattle Production
//       </h1>
//       <div className="text-base md:text-[30px] md:leading-8">
...
//       {/* image card */}
//       <div className="flex items-center justify-center  bg-white">
//         <div className="w-[1410px] h-[991px] bg-[#FAFBFB] border border-[#919291]">
//           <div className="pt-6">
//             <h1 className="text-bold text-[32px] font-bold text-center mb-6">
//               Support -A-Community of farmers
//             </h1>
...
//               src={donation}
//               alt="Support A Community of Farmers"
//               className="w-[1410px] h-[686px] object-cover"
//             />
//           </div>
//         </div>
//       </div>
//       <h1 className="font-bold text-2xl md:text-[34px] mt-14 text-center mb-2 mr-8">
//         Choose amount
//       </h1>
//       <h1 className="font-bold text-2xl md:text-[34px] leading-relaxed mb-4">
//         How much would you like to donate?
//       </h1>
//       <div className=" text-2xl md:text-[37px] mb-4 leading-10">
//         <p>
...
//       </div>
//       {/* buttons */}
//       <div className="grid grid-cols-1 md:grid-cols-5 gap-1 mt-16 text-[48px] font-bold">
//         <button className="w-[271px] rounded-md h-[105px] bg-[#D9D9D9] ">
//           USD5
//         </button>
//         <button className="w-[271px] rounded-md h-[105px] bg-[#D9D9D9] ">
//           USD10
...
//           USD20
//         </button>
//         <button className="w-[271px] rounded-md h-[105px] bg-[#155528]  text-white">
//           USD50
//         </button>
//         <button className="w-[271px] rounded-md h-[105px] text-[24px] leading- bg-[#D9D9D9] ">
//           Customise your donation
//         </button>
//       </div>
//       <h1 className="font-bold text-2xl md:text-[34px] leading-relaxed mb-4 mt-6">
//         Donner Information.
//       </h1>
//       <p className=" text-2xl md:text-[37px] mb-4 leading-10">
//         We will never share this information with anyone.
//       </p>
//       {/* form  */}
//       <div className="space-y-6 text-[40px] mt-16">
...
//               className="w-full h-[114px] pl-16 border bg-[#FAFBFB] border-[#919291] rounded-md text-black placeholder-black"
//             />
//           </div>
//           <input
//             type="text"
...
//             type="email"
//             placeholder="Email"
//             className="w-full h-[114px] pl-16 border bg-[#FAFBFB] border-[#919291] rounded-md placeholder-black"
//           />
//         </div>

//         {/* Country Dropdown */}
//         <div className="relative w-full">
//           <select className="w-full h-[114px] pl-16 border bg-[#FAFBFB] border-[#919291] rounded-md px-4 pr-10 appearance-none placeholder-black">
...
//           className="w-full h-[114px] pl-16 border bg-[#FAFBFB] border-[#919291] rounded-md px-4 placeholder-black"
//         />
//         <input
//           type="text"
...
//             type="text"
//             placeholder="Nairobi"
//             className="w-full pl-16 h-[114px] border bg-[#FAFBFB] border-[#919291] rounded-md px-4 placeholder-black"
//           />
//           <input
//             type="text"
...
//         </div>
//       </div>
//       <p className=" text-2xl md:text-[37px] mb-4 mt-16 leading-10">
//         To make a donation towards supporting a farmer, by direct deposit to
//         bank, follow this steps
//       </p>
//       <div className="flex items-center space-x-8 mb-4 mt-16">
//         <img src={okicon} alt="okicon" className="w-[71px] h-[74px]" />
//         <p className="text-2xl md:text-[37px]  leading-10">
//           I agree to the
//           <span className="text-[#155528] underline">terms and conditions</span>
//           of the donation
//         </p>
//       </div>
//       <div className="flex items-center space-x-2 justify-end">
//         <h1 className="text-[24px]">Edit Donation</h1>
//         <img src={editicon} alt="editicon" className="w-[55px] h-[54px]" />
//       </div>
...
//         {/* Row 1 */}
//         <div className="flex items-center justify-between w-[1376px] h-[114px] border border-[#919291] rounded-lg bg-[#FAFBFB] ">
//           <h1 className="text-[36px] pl-12  ">Payment amount</h1>
//           <h1 className="flex items-center justify-center w-[396px] h-[114px] border-2 border-[#919291] rounded-lg bg-[#F3F5F5] text-[36px] font-bold text-gray-800">
//             USD 100
//           </h1>
//         </div>

//         {/* Row 2 */}
//         <div className="flex items-center justify-between w-[1376px] h-[114px] border-2 border-[#919291] rounded-lg bg-[#FAFBFB] ">
//           <h1 className="text-[36px] pl-12  ">Frequency</h1>
//           <h1 className="flex items-center justify-center w-[396px] h-[114px] border-2 border-[#919291] rounded-lg bg-[#F3F5F5] text-[36px] font-bold text-gray-800">
//             One time
//           </h1>
//         </div>
...
//         {/* Row 3 */}
//         <div className="flex items-center justify-between w-[1376px] h-[114px] border-2 border-[#919291] rounded-lg bg-[#FAFBFB] ">
//           <h1 className="text-[36px] pl-12 font-bold ">Donation Total</h1>
//           <h1 className="flex items-center justify-center w-[396px] h-[114px] border-2 border-[#919291] rounded-lg bg-[#F3F5F5] text-[36px] font-bold text-gray-800">
//             USD 100
//           </h1>
//         </div>
...
//       </div>
//       {/* color wheel section */}
//       <div className="bg-[#FAFBFB] flex items-center justify-between mt-6 p-6 border-b-2 border-gray-300 rounded-md">
//         <div>
//           <h1 className="font-bold text-2xl md:text-[32px] mb-4">SDG No 13</h1>
...
const SeedDonationPage = () => {
  return (
    <div className="p-4 md:p-8  overflow-x-hidden">
      ...
      <div className=" text-xl md:text-[37px] mb-4  md:leading-10">
        <p>
          As a contributor to supporting the developments of farmers
          communities, we make sure that you donation goes directly in
          supporting our course.
      ...
      <div className="flex w-full space-x-4 mt-8">
        ...
        <a
          href="/seed-donation-confirmation"
