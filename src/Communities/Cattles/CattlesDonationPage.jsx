...
const CattlesDonationPage = () => {
  return (
    <div className="p-4 md:p-8  overflow-x-hidden">
      ...
      <img src={chickenimg} alt="chickenimg" className="w-full h-auto" />
      {/* nav */}
      ...
      <div className="flex w-full space-x-4 mt-8">
        ...
        <a
          href="/cattles-donation-confirmation"
...
export default CattlesDonationPage;
