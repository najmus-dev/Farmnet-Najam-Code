...
const ValueAdditionDashboard = () => {
  ...
  return (
    <div className="p-4 md:p-8 font-Inter overflow-x-hidden mb-96">
      ...
      />
      {/* nav */}
      <div className="flex items-center justify-between mt-10 mb-10 flex-wrap">
        ...
        {/* nav buttons */}
        <div className="flex flex-wrap space-x-1 md:space-x-4 space-y-2 md:space-y-0 mt-2 md:mt-0 font-medium text-base md:text-[24px] w-full md:w-auto">
          <a href="/buy-page" className="w-full md:w-auto">
            <button className="bg-[#EDF0EF] md:w-[254px] h-[50px] w-full px-2 py-1 md:py-2 rounded-md">
              Buy
            </button>
          </a>
          <a
...
export default ValueAdditionDashboard;
