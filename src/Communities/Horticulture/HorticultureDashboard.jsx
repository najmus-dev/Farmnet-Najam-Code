...
const HorticultureDashboard = () => {
  ...
  const [issecondCropDropdownOpen, setsecondCropDropdownOpen] = useState(false);

  // State for Second Livestock Dropdown
  const [isSecondLivestockDropdownOpen, setSecondLivestockDropdownOpen] =
    useState(false);

  // List of secondCrop options
  const secondCropOptions = [
    "Apples",
    "Avocado",
    "Bananas",
    "Beans",
  ...
  // Toggle for secondCrop Dropdown
  const togglesecondCropDropdown = () => {
    setsecondCropDropdownOpen(!issecondCropDropdownOpen);
  };
  ...
  return (
    <div className="p-4 md:p-8 font-Inter overflow-x-hidden mb-96">
      ...
      <img src={community4} alt="community4" className="w-full h-auto" />
      {/* nav */}
      <div className="flex items-center justify-between mt-10 mb-10 flex-col md:flex-row">
        <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-8 w-full md:w-auto">
          ...
          <div className="relative w-full md:w-auto">
            <div
              className="flex items-center justify-between space-x-4 md:space-x-36 font-bold text-xl md:text-[40px] cursor-pointer"
            ...
            {isCropOpen && (
              <div className="absolute mt-2 bg-[#EBEBEB] shadow-md rounded-md w-full z-10">
                <ul className=" space-y-2">
                  <li className="hover:bg-[#AFAFAF] p-2 cursor-pointer flex items-center space-x-2">
                    <img src={cropicon} alt="Crop Icon" className="w-6 h-6" />
                    <span>Apples</span>
                  </li>
                  {/* More items here... */}
                </ul>
      ...
      <div className="flex w-full flex-row space-x-4">
        ...
        <div className="relative w-full md:w-1/2">
          <button
            ...
            onClick={togglesecondCropDropdown}
          >
            Crop
            {/* Toggle between dropdown and dropup icon */}
            {issecondCropDropdownOpen ? (
          ...
          {issecondCropDropdownOpen && (
            <div className="absolute mt-2 w-full bg-[#EBEBEB] shadow-lg rounded-md z-10">
              <ul>
                {secondCropOptions.map((secondCrop, index) => (
                  <li
                    key={index}
...
export default HorticultureDashboard;
