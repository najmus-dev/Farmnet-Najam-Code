...
const VegetablesInvestmentTracker = () => {
  ...
  return (
    <div className="p-4 md:p-8 font-Inter overflow-x-hidden">
      ...
      {/* nav */}
      <div className="flex flex-col md:flex-row items-center justify-between mt-8 mb-10 md:space-x-10 space-y-6 md:space-y-0">
        {/* Dropdown Sections */}
        <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-8">
          ...
          <div className="relative w-full md:w-auto">
            ...
            {isCrop2Open && (
              <div className="absolute mt-2 shadow-md rounded-md w-[239px] z-10 bg-[#EBEBEB]">
        ...
        {/* Navigation Buttons */}
        {/* <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 font-medium text-base md:text-[24px] lg:w-auto"> */}
        <div className="flex flex-col md:flex-row items-center text-base md:text-[24px] font-medium space-y-4 md:space-y-0 md:space-x-4 w-full">
          ...
          <a href="/vegetables-investment-tracker" className="w-full md:w-auto">
            <button className="w-full md:w-[254px] bg-[#EDF0EF] hover:bg-[#155528] hover:text-white h-[50px] px-2 py-1 md:py-2 rounded-md">
              Invest
            </button>
          </a>
          <a href="/vegetables-donation-page" className="w-full md:w-auto">
            <button className="w-full md:w-[254px] bg-[#EDF0EF] hover:bg-[#155528] hover:text-white h-[50px] px-2 py-1 md:py-2 rounded-md">
              Donate
            </button>
          </a>
...
export default VegetablesInvestmentTracker;
