...
const cardData = [
  {
    ...
    link: "/admin/voice-of-farmaers-page-1",
  },
  {
    FarmerImage: farmer2,
    title: "Register as a Farmer",
    description: "Why Register as a farmer",
    link: "/admin/voice-of-farmaers-page-2",
  },
  {
    FarmerImage: farmer3,
    title: "Register as a Farmer",
    description: "Why Register as a farmer",
    link: "/admin/voice-of-farmaers-page-3",
  },
];

const VoiceOfFarmersMainPage = () => {
  return (
    <div>
      <MainHeader />
          ...
          <div className="grid grid-cols-1 gap-2">
            {cardData.map((card, index) => (
              <div
                ...
                style={{ backgroundImage: `url(${card.FarmerImage})` }}
              >
...
export default VoiceOfFarmersMainPage;
