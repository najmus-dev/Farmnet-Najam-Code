...
const cardData = [
  {
    aboutusImage: aboutus1,
    title: "Register as a Farmer",
    description: "Why Register as a farmer",
    link: "/admin/about-us-page-1",
  },
  {
    aboutusImage: aboutus2,
    title: "Register as a Farmer",
    description: "Why Register as a farmer",
    link: "/admin/about-us-page-2",
  },
  {
    aboutusImage: aboutus3,
    title: "Register as a Farmer",
    description: "Why Register as a farmer",
    link: "/admin/about-us-page-2",
  },
          ...
          <div className="grid grid-cols-1 gap-2">
            {cardData.map((card, index) => (
              <div
                ...
                style={{ backgroundImage: `url(${card.aboutusImage})` }}
              >
