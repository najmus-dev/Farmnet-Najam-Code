  ...
  return (
    <div>
      ...
      <div className="p-4 md:p-8 font-Inter overflow-x-hidden">
        ...
        <img src={communities1} alt="communities1" className="w-full h-auto" />
        {/* nav */}
        ...
        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row md:justify-between items-start md:items-center  mb-6 md:mb-10 text-xl">
          ...
          <div className="flex w-full md:w-auto flex-row space-x-1 md:space-x-2 font-medium text-base md:text-xl">
            <div className="relative w-1/2 md:w-[216px]">
              ...
              {isReportOpen && (
                <div className="absolute w-full bg-[#155528]  mt-1 z-10">
                  {reportTypes.map((reportType) => (
                    <div
                      key={reportType}
                      className="flex items-center p-3 hover:bg-[#1b6346] cursor-pointer"
              ...
              <div className="absolute mt-2 w-full bg-white shadow-lg rounded-md z-10">
                <ul>
                  {cropOptions.map((crop, index) => (
                    <li
                      key={index}
                      className="flex items-center px-4 py-2 text-lg hover:bg-gray-200 cursor-pointer"
                    >
                      <img
                        src={cropicon}
                        alt="Crop Icon"
        ...
        <p className="text-base md:text-[34px] leading-5 md:leading-10 ">
          ...
          significantly to maize production in
          <br className="md:block hidden" /> Kenya.
        </p>
        {/* save button */}
        <div className="flex justify-end items-end">
          <div className="flex justify-end gap-2 mt-4 mb-4 md:mb-60">
...
export default CommuniteisPage1b;
