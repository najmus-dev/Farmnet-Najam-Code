    ...
    <div>
      ...
      <div className="bg-white">
        <div className="w-full relative">
          ...
          />
          <IoAddCircleOutline className="absolute text-white top-2 right-6 w-6 h-6 md:w-10 md:h-10" />
          <img
            src={logo2}
            alt="service logo"
            className="absolute  left-6 bottom-2 w-[80px] sm:w-[98px] md:w-[208px] h-auto"
          />
        </div>
      </div>
...
export default FarmingDemoPage4;
