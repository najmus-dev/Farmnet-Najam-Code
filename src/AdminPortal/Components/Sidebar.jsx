...
const Sidebar = () => {
  ...
  const navItems = [
    // { label: "User Accounts", path: "/user-account" },
    // { label: "Dashboards", path: "/dashboards" },
    // { label: "Top Banner", path: "/top-banner-main-page" },
    // { label: "About us", path: "/about-us-main-page" },
    // { label: "Services", path: "/services-main-page" },
    // { label: "News", path: "news-main-page" },
    // { label: "Voice of Farmers", path: "/voice-of-farmaers-main-page" },
    // { label: "Reports", path: "/reports" },
    // { label: "Communities", path: "/communities" },
    // { label: "Resources", path: "/resources-main-page" },
        ...
        <nav className="py-6 flex flex-col w-full px-4">
          ...
          <div className="flex items-center mt-4">
            ...
            <h1 className="text-[24px] font-semibold">
              {" "}
              <a href="/settingPage" className="hover:underline">
                Settings
              </a>
            </h1>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 bg-black bg-opacity-50 z-50">
          <div className="fixed top-0 left-0 w-2/3 h-full bg-[#FAFBFB] shadow-lg p-4">
            ...
            <nav className="flex flex-col">
              <a href="/overview" className="text-[24px] font-semibold mb-4">
                Overview
              </a>
