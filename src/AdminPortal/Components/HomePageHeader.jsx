...
const HomePageHeader = () => {
  ...
  return (
    <div className="font-Inter md:px-4 py-2 md:py-4">
      <div className="flex justify-between mb-4 md:mb-8">
        <h1 className="font-bold text-[20px] md:text-[32px]">NAMIBIA</h1>
      ...
      <div className="flex flex-col md:flex-row justify-between">
        ...
        {/* Search and Filters */}
        <div className="flex flex-col gap-4 lg:flex-row items-center md:mb-6 w-full md:w-auto mt-4 md:mt-0">
          {/* Search Input */}
